...
class AlmutenZodsWnd(commonwnd.CommonWnd):
    ...
    def __init__(self, parent, chrt, options, mainfr, id = -1, size = wx.DefaultSize):
        ...
        self.TABLE_WIDTH = int(self.SMALL_CELL_WIDTH+self.LONGITUDE_CELL_WIDTH+(self.COLUMN_NUM)*(self.CELL_WIDTH)+self.DEGREEWINS_CELL_WIDTH)
        self.TABLE_HEIGHT = int(self.TITLE_HEIGHT+self.LINE_NUM*self.LINE_HEIGHT)
