...
class GraphChart:
    ...
    def drawChart(self):
        ...
        # Javier changed from deprecated EmptyImage to Image instead
        ...
        # Javier changed from deprecated BitmapFromImage to Bitmap instead
        ...
        wxImag = self.buffer.ConvertToImage()
        self.img = Image.new('RGB', (wxImag.GetWidth(), wxImag.GetHeight()))
        # Javier changed from fromstring to frombytes
        #self.img.fromstring(wxImag.GetData())
        self.img.frombytes(bytes(wxImag.GetData()))
        self.draw = ImageDraw.Draw(self.img)
    ...
    def drawCircles(self):
        ...
        self.bdc.Clear()
        # Javier commented because Phoenix
