...
class DefaultLocDlg(wx.Dialog):
    ...
    def __init__(self, parent, langid):
        ...
        # method.
        # Javier changed wx.PreDialog to wx.Dialog.__init__
        #pre = wx.PreDialog()
        ...
        self.Create(parent, -1, mtexts.txts['DefaultLocation'], pos=wx.DefaultPosition, size=wx.DefaultSize, style=wx.DEFAULT_DIALOG_STYLE)
        ...
        fgsizer = wx.FlexGridSizer(2, 4, 1)
...
#       fgsizer.AddGrowableCol(4, 0)
        ...
        fgsizer = wx.FlexGridSizer(1, 2, 1)
        vvsizer = wx.BoxSizer(wx.VERTICAL)
