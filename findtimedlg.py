...
class ResListCtrl(wx.ListCtrl):
    ...
    def OnItemSelected(self, event):
        # Javier changed m_itemIndex for GetIndex
...
#       self.bcckb.Enable(False)
        ...
        mhsizer.Add(vsizer, 0, wx.GROW, 0)
