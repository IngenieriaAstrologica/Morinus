...
class PrimDirsListWnd(wx.ScrolledWindow):
    ...
    def __init__(self, parent, chrt, options, pds, mainfr, currpage, maxpage, fr, to, id = -1, size = wx.DefaultSize):
        ...
        self.SMALL_CELL_WIDTH = int(4*self.FONT_SIZE)
        self.CELL_WIDTH = int(6*self.FONT_SIZE)
        self.BIG_CELL_WIDTH = int(8*self.FONT_SIZE)
        self.TABLE_WIDTH = int(2*self.SMALL_CELL_WIDTH+3*self.CELL_WIDTH+self.BIG_CELL_WIDTH)
        self.SPACE_TITLEY = 4
        self.TITLE_CELL_HEIGHT = int(2*self.LINE_HEIGHT)
        self.TABLE_HEIGHT = int((self.TITLE_CELL_HEIGHT)+(self.SPACE_TITLEY)+(self.LINE_NUM)*(self.LINE_HEIGHT))
        self.SPACE_BETWEEN_TABLESX = 4
        self.TITLE_CELL_WIDTH = int(2*self.TABLE_WIDTH+self.SPACE_BETWEEN_TABLESX+1)
