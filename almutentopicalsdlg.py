...
class RowsListCtrl(wx.ListCtrl):
    ...
    def OnItemSelected(self, event):
        # Javier changed m_itemIndex to GetIndex
...
#           return
        ...
        # Javier changed deprecated InsertStringItem to InsertItem
        #self.InsertStringItem(num, item[RowsListCtrl.TYPE])
        self.InsertItem(num, item[RowsListCtrl.TYPE])
        for i in range(1, len(item)):
            # Javier changed deprecated SetStringItem to SetItem
...
class AlmutenTopicalsDlg(wx.Dialog):
    ...
    def __init__(self, parent, opts):
        ...
        # Javier changed choices from '' to []
