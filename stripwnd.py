...
#       num = planets.Planets.PLANETS_NUM-1+1+2#Planets-DescNode+LoF+AscMC
        ...
        if order[0]+bshift[0] < BOR:
            ...
            for i in range(len(order)-1):
                ...
                if i < tidx:
                    ...
                    w1, h1 = get_size(self.fntMorinus, common.common.Planets[i])
                elif i == tidx:
                    ...
                    w1, h1 = get_size(self.fntText, self.ascmctxt[0])
                elif i == tidx+2:
                    #w1, h1 = self.fntText.getsize(self.ascmctxt[1])
                    w1, h1 = get_size(self.fntText, self.ascmctxt[1])

                w2, h2 = 0.0, 0.0
                if i < tidx:
                    #w2, h2 = self.fntMorinus.getsize(common.common.Planets[i])
                    w2, h2 = get_size(self.fntMorinus, common.common.Planets[i])
                elif i == tidx:
                    ...
                    w2, h2 = get_size(self.fntText, self.ascmctxt[0])
                elif i == tidx+2:
                    #w2, h2 = self.fntText.getsize(self.ascmctxt[1])
                    w2, h2 = get_size(self.fntText, self.ascmctxt[1])
    ...
    def doShift(self, b1, b2, bshift, order, mixed, forward = False):
        ...
        if mb1 < tidx:
            ...
            w1, h1 = get_size(self.fntMorinus, common.common.Planets[mb1])
        elif mb1 == tidx:
            #w1, h1 = self.fntMorinus.getsize(common.common.fortune)
            w1, h1 = get_size(self.fntMorinus, common.common.fortune)
        elif mb1 == tidx+1:
        ...
        if mb2 < tidx:
            ...
            w2, h2 = get_size(self.fntMorinus, common.common.Planets[mb2])
        elif mb2 == tidx:
            #w2, h2 = self.fntMorinus.getsize(common.common.fortune)
            w2, h2 = get_size(self.fntMorinus, common.common.fortune)
        elif mb2 == tidx+1:
