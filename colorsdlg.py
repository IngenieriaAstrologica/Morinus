...
class ColorsDlg(wx.Dialog):
    def __init__(self, parent):
        ...
        # Javier changed GridSizer
        #gsizer = wx.GridSizer(5, 2)
        gsizer = wx.GridSizer(5, 2, 1)
        ...
        hsizer.Add(self.btnBackground, 0, wx.ALL, 2)
        ...
        hsizer.Add(self.btnTable, 0, wx.ALL, 2)
        ...
        hsizer.Add(self.btnTexts, 0, wx.ALL, 2)
        ...
        hsizer.Add(self.useplanetcolorsckb, 0, wx.ALL, 2)

        horsizer.Add(hsizer, 0, wx.ALIGN_CENTER_VERTICAL|wx.LEFT, 10)

        #mvsizer.Add(horsizer, 0, wx.GROW|wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.RIGHT|wx.BOTTOM, 5)
        mvsizer.Add(horsizer, 0, wx.GROW|wx.LEFT|wx.RIGHT|wx.BOTTOM, 5)
        ...
        # Deprecated wx.EVT_BUTTON use Bind instead
        ...
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Frame)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Signs)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_AscMC)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Houses)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_HouseNumbers)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Positions)
        #self.btnFrame         = wx.Button(self, id=ID_BTN_Frame, label="Frame")
        #self.btnSigns         = wx.Button(self, id=ID_BTN_Signs, label="Signs")
        #self.btnAscMC         = wx.Button(self, id=ID_BTN_AscMC, label="AscMC")
        #self.btnHouses        = wx.Button(self, id=ID_BTN_Houses, label="Houses")
        #self.btnHousesNumbers = wx.Button(self, id=ID_BTN_HouseNumbers, label="HouseNumbers")
        #self.btnPositions     = wx.Button(self, id=ID_BTN_Positions, label="Positions")
        #self.btnFrame.Bind(wx.EVT_BUTTON, self.onBtn)
        #self.btnSigns.Bind(wx.EVT_BUTTON, self.onBtn)
        #self.btnAscMC.Bind(wx.EVT_BUTTON, self.onBtn)
        #self.btnHouses.Bind(wx.EVT_BUTTON, self.onBtn)
        #self.btnHousesNumbers.Bind(wx.EVT_BUTTON, self.onBtn)
        #self.btnPositions.Bind(wx.EVT_BUTTON, self.onBtn)
        ...
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Domicil)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Exal)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Peregrin)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Casus)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Exil)
        ...
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Sun)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Moon)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Mercury)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Venus)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Mars)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Jupiter)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Saturn)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Uranus)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Neptune)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Pluto)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Nodes)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_LoF)
        ...
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Conjunctio)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Semisextil)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Semiquadrat)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Sextil)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Quintile)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Quadrat)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Trigon)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Sesquiquadrat)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Biquintile)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Quinqunx)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Oppositio)
        ...
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Background)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Table)
        self.Bind(wx.EVT_BUTTON, self.onBtn, id=ID_BTN_Texts)
